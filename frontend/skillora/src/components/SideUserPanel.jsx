...
const SideUserPanel = () => {
    ...
    return (
        <div style={{ width: '20%', position: 'fixed', marginTop: '5%', left: 0, margin: '1%', boxShadow: 'rgb(210, 210, 210) 0px 0px 20px 0px', height: '-webkit-fill-available', backgroundColor: 'white' }}>
            <Row>
